      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <div className="bg-black/50 border-2 border-red-700 rounded-2xl p-8 sm:p-12 shadow-[0_0_40px_rgba(239,68,68,0.5)] backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-2xl sm:text-4xl font-bold text-gray-500 line-through">R$97</span>
          </div>
          ...
          <p className="mt-6 text-sm text-gray-400">Ambiente 100% seguro. Compra processada pela Kiwify.</p>
        </div>
      </div>
    </section>
  );
